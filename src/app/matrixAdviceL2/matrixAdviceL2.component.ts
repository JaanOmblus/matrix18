...
@Component({ // Add the @Component decorator.
  selector: 'matrix-adviceL2', 
  templateUrl: './matrixAdviceL2.component.html',
  styleUrls: ['./matrixAdviceL2.component.css']
})


export class AdviceL2Component implements AfterContentInit { 


text3 = "seecccc on uus tekst proovimiseks, eriti pikemaks proovimiseks";
...
anime.timeline()
.add({targets: '.an-2 .letter2',
//scale: [4,1],
opacity: [0,1],
//duration: 950,
delay: (ell:any, ii:any) => 120*ii
